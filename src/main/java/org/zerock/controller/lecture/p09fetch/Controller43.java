...
public class Controller43 {
	...
	public void method1(String name, String address) {
		System.out.println("첫번째 method 일함");
	...
	public void method2(String email, Integer age) {
		System.out.println("두번째 method 일함");
	...
	public void method3(String name, String email) {
		System.out.println("세번째 method 일함");
	...
	@GetMapping("sub04")
	public void method1(String address, Integer age) {
		System.out.println("네번째 method 일함");
		System.out.println(address);
	...
	public void method5(String address, Integer age) {
		System.out.println("5번 method 일함");
		System.out.println(address);
		System.out.println(age);		
	}
	
	@PostMapping("sub06")
	public void method5(String name, String email) {
		System.out.println("6번 method 일함");
		System.out.println(name);
	...
	public void method8(String address, Integer age) {
		System.out.println("여덟번째 method 일함");
		System.out.println(address);
		System.out.println(age);
	}
}
