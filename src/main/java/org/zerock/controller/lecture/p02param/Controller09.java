...
public class Controller09 {
	...
	// sub02 경로, get방식, name request param 받을 수 있는 @RequestParam
	// name request param 받아서 출력
	
	@GetMapping("sub02")
	public void method2(@RequestParam(name = "name") String s) {
		System.out.println("name : " + s);
	}
	
	@GetMapping("sub03")
	public void method3(@RequestParam(value = "name") String s) {
		System.out.println("name : " + s);
	}
	
	@GetMapping("sub04")
	public void method4(@RequestParam("name") String s) {
		System.out.println("name : " + s);
	}
