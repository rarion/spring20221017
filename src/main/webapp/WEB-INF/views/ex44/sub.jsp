...
<body>
	...
	<input type="text" id="nameInput2" value="박지성" name="name"> <br>
	<input type="text" id="locationInput2" value="런던" name="location"> <br>
	<input type="text" id="sinceInput2" value="2000년" name="since">
	<br>
	<button id="btn13">/ex44/sub04 post, form->obj->json</button>
	<br>
	age <input type="number" id="ageInput3"> <br>
	name <input type="text" id="nameInput3"> <br>
	...
	food:커피 <input type="checkbox" class="foodCheckbox3" value="커피"> <br>
	...
	<button id="btn16">/ex44/sub16/99 get</button> <br>
	<input type="number" id="input16" value="99"> <br>
...
<script>
	...
	document.querySelector("#btn13").addEventListener("click",function(){
		...
		const foodCheckBoxes = document.querySelectorAll(".foodCheckbox3:checked")
		const food = [];
       	for (const foodCheckBox of foodCheckBoxes){ //for of
	...
	document.querySelector("#btn9").addEventListener("click", function(){
		const o = {address:"서울", score:88.8, phone:["1111", "2222"], married:true}
	...
	document.querySelector("#btn5").addEventListener("click",function(){
		fetch(ctx+"/ex44/sub05", {
			...
			body: `{"address" : "seoul", "score" : "99.9", "phone" : ["010-0000-0000", "010-1111-1111"], "married" : true}`
		});
	});
