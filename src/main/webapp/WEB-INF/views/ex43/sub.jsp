...
<body>
	...
	<br>
	<button id="btn8">/ex43/sub08 post 요청 #form2 활용</button>
...
document.querySelector("#btn3").addEventListener("click", function(){
	const form1 = document.forms.form1; //  document.querySelector("#form1")
...
document.querySelector("#btn2").addEventListener("click", function(){
	fetch(ctx + "/ex43/sub02?email=k@na.com&age=20");
});
</script>
